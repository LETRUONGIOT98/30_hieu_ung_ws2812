...
#define PIXEL_PIN D3   // pin 5 collegato alla strip /strip data pin 
#define NUMPIXELS 7 // Numero dei Led/Pixel / number of pixels/leds on the strip

Adafruit_NeoPixel strip(NUMPIXELS, PIXEL_PIN, NEO_GRB + NEO_KHZ800); // C'è la possibilità che la vostra strip non funzioni e  abbia bisogno di cambiare il valore NEO_KHZ800 in NEO_KHZ400 // change the value NEO_KHZ800 into NEO_KHZ400 if your strip dont works
int selectedEffect;
int h=0;
void setup() {
  Serial.begin(115200);
